...
changeMaterialRadio = function(value){
    ...
    switch(value){
        case "gold":
            material.color = t3color("FFE27B");
            material.emissive = t3color("FFE27B");
            break;
        case "silver":
            material.color = t3color("D5E1E5");
            material.emissive = t3color("D5E1E5");
            break;
        case "brass":
            material.color = t3color("EDBB4F");
            material.emissive = t3color("EDBB4F");
            break;
        default:
