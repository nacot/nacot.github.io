...
function rippleCircle(){
    ...
    this.update = function(){
        if(this.active){
            ...
            /*
            if(this.age<30) temp = this.age/30;
            if(this.age>30) temp = 1 - (this.age-30)/40;
            //*/
...
function drawLiveCreationHelpers() {
    ...
    */
    ...
    if(rippleStartBuffer > 2000){
        rippleStartBuffer -= 2000;
        ripples[rippleToUpdate] = new rippleCircle();
