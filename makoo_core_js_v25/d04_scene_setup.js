...
light.position.set( 400, 200, 500 );
scene.add( light );
...
multiMaterial = [ material, simpleShadeMaterial ];

var colorGold = t3color("FFDD40");
var colorSilver = t3color("EDF5F7");
var colorBrass = t3color("FFC263");

changeMaterialRadio = function(value){
    clog("changing material...");
    switch(value){
        case "gold":
            simpleShadeMaterial.opacity = 0.6;
            simpleShadeMaterial.color = colorGold;
            material.emissive = colorGold;
            break;
        case "silver":
            simpleShadeMaterial.opacity = 0.2;
            simpleShadeMaterial.color = colorSilver;
            material.emissive = colorSilver;
            break;
        case "brass":
            simpleShadeMaterial.opacity = 0.3;
