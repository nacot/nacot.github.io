(function() {
	tinymce.create('tinymce.plugins.embedvideoPlugin', {
		init : function(ed, url) {
			...
			// Register buttons
			ed.addButton('embedvideo', {title : 'Insert Video', cmd : 'mceembedvideo', image: url + '/images/video.png' });
		}
	});
	...
	tinymce.PluginManager.add('embedvideo', tinymce.plugins.embedvideoPlugin);
