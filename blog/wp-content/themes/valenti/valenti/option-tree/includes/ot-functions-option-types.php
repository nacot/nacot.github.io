        ...
        if ( ! empty( $categories ) ) {
          foreach ( $categories as $category ) {
            echo '<p>';
              ...
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $category->term_id ) . '">' . esc_attr( $category->name ) . '<span></span></label>';
            echo '</p>';
          } 
        } else {
        ...
        foreach ( (array) $field_choices as $key => $choice ) {
          if ( isset( $choice['value'] ) && isset( $choice['label'] ) ) {
            echo '<p>';
              ...
              echo '<label for="' . esc_attr( $field_id ) . '-' . esc_attr( $key ) . '">' . esc_attr( $choice['label'] ) . '<span></span></label>';
            echo '</p>';
          }
        }
      ...
      echo '<div class="format-setting-inner">';
        ...
        foreach ( (array) $field_choices as $key => $choice ) {
          ...
          echo '<div class="option-tree-ui-radio-images">';
            ...
            echo '<img src="' . get_template_directory_uri().'/option-tree/assets/images/options'. esc_url( $choice['src'] ) . '" title="' . esc_attr( $choice['label'] ) .'" class="option-tree-ui-radio-image ' . esc_attr( $field_class ) . ( $field_value == $choice['value'] ? ' option-tree-ui-radio-image-selected' : '' ) . '" />';
          echo '</div>';
        }
