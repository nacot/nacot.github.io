    ...
    function nimbus_page_render() {
        ...
        <div id="options_wrapper">
            <div id="options_header">	
                ...
                <a href="http://www.nimbusthemes.com/join/?utm_source=simple&utm_medium=theme&utm_content=panel_banner&utm_campaign=simple"><img id="panel_banner" src="<?php echo get_template_directory_uri(); ?>/nimbus/images/become-member.jpg" alt='Become a Member'  /></a>
            </div>
            <div id="options_content">	
                ...
                <div id="form_wrapper">
                    ...
                    <form action="options.php" method="post" id="nimbus_form">
                        ...
                        ?>
                        <a id="support_options_top" target="_blank" class="nimbus_button_orange" href="http://www.nimbusthemes.com/join/?utm_source=simple&utm_medium=theme&utm_content=suport_button&utm_campaign=simple">Support</a> 
                        <div id="membership">
                        ...
                        ?>  
                        <a id="support_options_bottom" target="_blank" class="nimbus_button_orange" href="http://www.nimbusthemes.com/join/?utm_source=simple&utm_medium=theme&utm_content=suport_button&utm_campaign=simple">Support</a> 
                    </form>
                </div>
